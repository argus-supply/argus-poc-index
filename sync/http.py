...
HOSTS = frozenset(('api.github.com', 'raw.githubusercontent.com', 'codeload.github.com', 'gitlab.com',
...
def allowed(url):
    ...
    if parsed.hostname == 'codeload.github.com' and (
            not re.fullmatch(r'/argus-supply/argus-intel-data/tar\.gz/[a-f0-9]{40}', parsed.path)
            or parsed.query or parsed.fragment):
        raise FetchError('codeload archive is outside the fixed dependency scope')
    return parsed
