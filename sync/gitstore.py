...
class GitStore:
    def __init__(self, path, remote, token=None):
        ...
        # Environment configuration covers this repository only: local-path
        # pushes scrub GIT_CONFIG_* before receive-pack, so a receiving
        # repository disables its own post-push maintenance in its config.
